...
const workExperiences = [
  {
    ...
    topics: [
          ...
          'Researched and meticulously planned a <strong>Vue 2 to Vue 3 migration</strong>, accounting for every code and package change. Executed said plan <strong>within the span of a year</strong>, with minimal impact on the team and the product.',
