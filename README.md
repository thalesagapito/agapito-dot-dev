...
[`<script setup>`](https://github.com/vuejs/rfcs/pull/227) is a feature that is currently in RFC stage. To get proper IDE support for the syntax, use
[Volar](https://marketplace.visualstudio.com/items?itemName=johnsoncodehk.volar) instead of Vetur (and disable Vetur).
...
example to get props validation when using manual `h(...)` calls), you can use the following:
...
hands emoji juggling language icons to show that I work with multiple things
